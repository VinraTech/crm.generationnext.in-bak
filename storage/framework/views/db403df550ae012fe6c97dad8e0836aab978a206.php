                            ...
                            <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                ...
                                <thead>
                                    ...
                                    <tr role="row" class="filter">
                                        ...
                                        <td><input type="text" class="form-control form-filter input-sm" name="name" placeholder="Client Name" <?php if(isset($_GET['name'])): ?> value="<?php echo e($_GET['name']); ?>" <?php endif; ?>></td>
...
<div class="modal fade" id="FileExportModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <form  action="<?php echo e(url('s/admin/export-partially-files')); ?>" method="post"><?php echo e(csrf_field()); ?>
