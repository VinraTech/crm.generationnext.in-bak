...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo e(URL::asset('css/backend_css/login-soft.css')); ?>" />
		...
		<link rel="shortcut icon" href="<?php echo e(asset('images/metro.ico')); ?>"/>
	</head>
	<body class="login">
		<div class="logo">
			<a href="index.html">
	...
	<!-- Scripts starts from here -->
		...
		<script src="<?php echo asset('js/backend_js/bootstrap/js/bootstrap.min.js'); ?>" type="text/javascript"></script>
		...
		<script src="<?php echo asset('js/backend_js/jquery.backstretch.min.js'); ?>" type="text/javascript"></script>
		...
		<script type="text/javascript">
			jQuery(document).ready(function() {     
				...
				Layout.init(); // init current layout
	  			Demo.init();
	       		$.backstretch([
		       		'<?php echo e(URL::asset('/images/LoginImages/first.jpg')); ?>',
			        '<?php echo e(URL::asset('/images/LoginImages/1.jpg')); ?>',
			        '<?php echo e(URL::asset('/images/LoginImages/3.jpg')); ?>'
		        ], {
		         	fade: 1000,
		          	duration: 1000
		    		}
