        ...
        <table class="table table-bordered">
			...
			<?php $__currentLoopData = $getTeamLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
						...
						<td class="text-left"><?php echo e($level['id']); ?></td>
						<td class="text-left"><span class="team_id"><?php echo e($level['team_id']); ?> </span> <span class="root">ROOT </span><span class="root"> <?php echo e($level['name']); ?> - <?php echo e($getEmpType->full_name); ?></span></td>
					...
					<?php $__currentLoopData = $level['getemps']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skey => $sublevel1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
								<td class="text-left"><?php echo $no = $no+1; ?></td>
								<td class="text-left"><?php echo e($sublevel1['id']); ?></td>
								<td class="text-left"><span class="team_id"><?php echo e($sublevel1['team_id']); ?> </span>&nbsp;&nbsp;&nbsp;&nbsp;&raquo; &nbsp;<span class="level_1">level 1</span><span class="level_1"><?php echo e($sublevel1['name']); ?> - <?php if(isset($getEmpType->full_name)): ?><?php echo e($getEmpType->full_name); ?><?php endif; ?></span></td>
						        <td class="text-left" onclick="view_emp_details()"><span class="emp-info">View</span></td>
						</tr>
						<?php $__currentLoopData = $sublevel1['getemps']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sskey=> $sublevel2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							...
							?>
                            	  <tr style="border:none!important">
										<td class="text-left"><?php echo $no = $no+1; ?></td>
										<td class="text-left"><?php echo e($sublevel2['id']); ?></td>
										<td class="text-left"><span class="team_id"><?php echo e($sublevel2['team_id']); ?> </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&raquo; &raquo; &nbsp;<span class="level_2">level 2</span><span class="level_2"><?php echo e($sublevel2['name']); ?> - <?php echo e($getEmpType->full_name); ?></span></td>
										<td class="text-left" onclick="view_emp_details()"><span class="emp-info">View</span></td>
									</tr>
                            <?php
                            ...
                            <?php $__currentLoopData = $getdetails['getemps']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ssskey=> $sublevel3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								...
								?>
								   ...
								   <tr>
										<td class="text-left"><?php echo $no = $no+1; ?></td>
										<td class="text-left"><?php echo e($sublevel3['id']); ?></td>
										<td class="text-left"><span class="team_id"><?php echo e($sublevel3['team_id']); ?> </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&raquo; &raquo; &raquo; &nbsp;<span class="level_3">level 3</span><span class="level_3"><?php echo e($sublevel3['name']); ?> - <?php echo e($getEmpType->full_name); ?></span></td>
									    <td class="text-left" onclick="view_emp_details()"><span class="emp-info">View</span></td>
									</tr>
                                ...
                                <?php $__currentLoopData = $getdetails['getemps']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sssskey=> $sublevel4): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									...
									<tr>
										<td class="text-left"><?php echo $no = $no+1; ?></td>
										<td class="text-left"><?php echo e($sublevel4['id']); ?></td>
										<td class="text-left"><span class="team_id"><?php echo e($sublevel4['team_id']); ?> </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&raquo; &raquo; &raquo; &raquo; &nbsp;<span class="level_4">level 4</span><span class="level_4"><?php echo e($sublevel4['name']); ?> - <?php echo e($getEmpType->full_name); ?></span></td>
									    <td class="text-left" onclick="view_emp_details()"><span class="emp-info">View</span></td>
									</tr>
