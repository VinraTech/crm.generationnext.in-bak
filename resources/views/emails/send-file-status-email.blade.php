<html>
    ...
    <body>
        <table width='80%' border='0' cellpadding='3' cellspacing='3' style='border:#EFEFEF 5px solid; padding:5px;'>
            ...
            <tr>
                <td class='style2'>Hello! File status has been updated successfully. Details are below:-</td>
            </tr>
             <tr>
                <td>&nbsp;</td>
            </tr>           
               ...
               <td align='left' valign='middle'>
                   <table width='98%' border='0' align='right' cellpadding='5' cellspacing='5' style='background-color:#F5F5F5'>
                        ...
                        <tr>
                           ...
                           <td width='5%' align='left' valign='top' class='style2'>:</td>
                           <td width='65%' align='left' valign='top' class='style3'>{{ $data['file_status'] }}</td>
                        </tr>
                        @if(!empty($banks))
                            <tr>
                        ...
                        <tr>
                           ...
                           <td width='5%' align='left' valign='top' class='style2'>:</td>
                           <td width='65%' align='left' valign='top' class='style3'>{{ $data['comments'] }}</td>
                        </tr>
                   </table>
               </td>
           </tr>
