<html>
    ...
    <body>
        <table width='80%' border='0' cellpadding='3' cellspacing='3' style='border:#EFEFEF 5px solid; padding:5px;'>
            ...
            <tr>
                <td class='style2'>Hello! {{$name}}!. Move to Bank Approval needed for below file:-</td>
            </tr>
             <tr>
                <td>&nbsp;</td>
            </tr>           
               ...
               <td align='left' valign='middle'>
                   <table width='98%' border='0' align='right' cellpadding='5' cellspacing='5' style='background-color:#F5F5F5'>
                        ...
                        <tr>
                           ...
                           <td width='5%' align='left' valign='top' class='style2'>:</td>
                           <td width='65%' align='left' valign='top' class='style3'>{{ $filedetails['client_name'] }}</td>
                        </tr>
                        @if(!empty($banks))
                            <tr>
                                <td width='30%' align='left' valign='top' class='style2'>Banks</td>
                                <td width='5%' align='left' valign='top' class='style2'>:</td>
                                <td width='65%' align='left' valign='top' class='style3'>{{ $banks }}</td>
                            </tr>
                        @endif
                        <tr>
                           <td width='30%' align='left' valign='top' class='style2'>Approval from</td>
                           <td width='5%' align='left' valign='top' class='style2'>:</td>
                           <td width='65%' align='left' valign='top' class='style3'>{{ $approvalfrom }}</td>
                        </tr>
                   </table>
               </td>
           </tr>
