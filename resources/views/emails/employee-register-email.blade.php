<html>
    ...
    <body>
        <table width='80%' border='0' cellpadding='3' cellspacing='3' style='border:#EFEFEF 5px solid; padding:5px;'>
            ...
            <tr>
                <td class='style2'>Hi {{$empname}} ! Your account has been created successfully. Details are below:-</td>
            </tr>
             <tr>
                <td>&nbsp;</td>
            </tr>           
               ...
               <td align='left' valign='middle'>
                   <table width='98%' border='0' align='right' cellpadding='5' cellspacing='5' style='background-color:#F5F5F5'>
                        <tr>
                           ...
                           <td width='65%' align='left' valign='top' class='style3'>{{ $empname }}</td>
                        </tr>
                        <tr>
                           <td width='30%' align='left' valign='top' class='style2'>Type</td>
                           <td width='5%' align='left' valign='top' class='style2'>:</td>
                           <td width='65%' align='left' valign='top' class='style3'>{{$type}}</td>
                        </tr>
                        <tr>
                           <td width='30%' align='left' valign='top' class='style2'>Employee Code</td>
                           <td width='5%' align='left' valign='top' class='style2'>:</td>
                           <td width='65%' align='left' valign='top' class='style3'>{{ $empcode}}</td>
                        </tr>
                        <tr>
                           <td width='30%' align='left' valign='top' class='style2'>Email</td>
                           <td width='5%' align='left' valign='top' class='style2'>:</td>
                           <td width='65%' align='left' valign='top' class='style3'>{{ $empemail}}</td>
                        </tr>
                        <tr>
