                            ...
                            <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                <thead>
                                    ...
                                    <tr role="row" class="filter">
                                        ...
                                        <td><input type="text" class="form-control form-filter input-sm" name="name" placeholder="Client Name" @if(isset($_GET['customer_name'])) value="{{$_GET['customer_name']}}" @endif></td>
...
<div class="modal fade" id="FileExportModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form  action="{{url('s/admin/export-file-history')}}" method="post">{{csrf_field()}}
