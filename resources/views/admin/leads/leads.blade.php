            ...
            <div class="col-md-12">
                <div class="portlet light">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <!-- <div class="btn-group">
                                <a href="{{url('/s/admin/export-leads')}}"><img width="30" src="{{ asset('images/excel.png')}}"></a>
                            </div> -->
                        </div>
                    </div>
                         ...
                         <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <div class="btn green">
                                            <a href="{{action('LeadController@addLead')}}" style="text-decoration:none; color:white">Add Lead</a> <i class="fa fa-plus"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
